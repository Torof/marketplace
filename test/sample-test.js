...
describe("Marketplace", function () {
  ...
  it("4) it should have no offers registered yet", async () => {
  ...
  it("5) it should revert with 'ERC721: caller is not token owner nor approved' when a submitting a new sale order without approval - ERC721 -", async () => {
  ...
  it("6) it should create a sale and offer1 have seller, contract address, price , tokenId, standard be ERC721 and closed be false - ERC721 - ", async () => {
    expect(await n721.ownerOf(1)).to.equal(owner.address)
  ...
  // createSale() revert on not approved for {ERC721}
  it("7) it should revert with 'ERC1155: caller is not token owner nor approved' when a submitting a new sale order without approval - ERC1155 -", async () => {
  ...
  it("8) it should create a sale and offer2 have seller, contract address, price , tokenId, standard be ERC1155 and closed be false, - ERC1155 - ", async () => {
    expect(await n1155.balanceOf(owner.address, 1)).to.not.equal(0)
  ...
  it("9) it should create a sale & emit a 'Transfer' event & a 'SaleCreated' event", async () => {
  ...
  it("10) it should revert with 'not owner' when an address creates a sale for a NFT (erc721) it doesn't own ", async () => {
  ...
  it("11) it should revert with 'not owner' when an address creates a sale for a NFT (erc1155) it doesn't own ", async () => {
  ...
  it("12) it should revert with 'not owner' when an other address than the seller tries to modify it ", async () => {
    await expect(marketplace.connect(acc1).modifySale(1, 2)).to.be.revertedWith("not owner")
  })

  // modifySale success
  it("13) it should have owner of a sale able to modify it", async () => {
  ...
  it("15) it should revert if sale is already closed", async () => {
    let offer1 = await marketplace.getOffer(1)
  ...
  it("16) it should revert with 'not owner' if not the owner tries to cancel the sale", async () => {
    await expect(marketplace.connect(acc1).cancelSale(2)).to.be.revertedWith('not owner')
  })

  // buySale() revert wrong amount
  it("17) it should revert if not right amount of ether is supplied", async () => {
  ...
  // buySale() success
  it("18) it should succesfully buy sale order 1 and be new owner of NFT", async () => {
  ...
  it("19) it should revert with 'offer is closed' when trying to buy an offer that is closed", async () => {
  ...
  it("20) it should sucesfully submit an offer", async () => {
  ...
  it("21) it should successfuly accept new offer. Offerer should be debited &previous offerer refunded", async () => {
    let offer5 = await marketplace.getOffer(5)
  ...
  it("22) it should revert on new offer lower than previous one", async () => {
  ...
  it("23) it should accept offer send funds to previous owner and transfer NFT to new owner", async () => {
    let offer5 = await marketplace.getOffer(5)
  ...
  it("24) it should revert new offer if offer is closed", async () => {
  ...
  it("25) it should revert cancelSale() with '48h minimum before cancel'", async () => {
